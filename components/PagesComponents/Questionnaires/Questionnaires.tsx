...
export const Questionnaires = () =>{
    ...
    const downloadImage = (src: string) => {
        saveAs(src, 'image.png') // Put your image URL here.
    }
        ...
        <div className="w-[90%] xl:w-[1350px] mx-auto p-[20px] my-[20px] lg:mb-[100px]">
            ...
            <section className='flex flex-col items-center md:flex-row justify-around mt-[70px] '>
                <div className="flex flex-col items-center">
                    ...
                    <button className="mt-[30px] bg-[#0f4b84] text-[#fff] px-[20px] py-[5px] text-[16px] rounded-xl" onClick={()=>downloadImage(sfa.src)}>Скачать</button>
                </div>
                <div className="flex flex-col items-center max-md:mt-[50px]">
                    ...
                    <button className="mt-[30px] bg-[#0f4b84] text-[#fff] px-[20px] py-[5px] text-[16px] rounded-xl" onClick={()=>downloadImage(wilo.src)}>Скачать</button>
                </div>
            </section>
        </div>
    )
